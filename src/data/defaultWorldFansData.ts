...
export const defaultWorldGroups: WorldGroup[] = [
  ...
  {
    id: 'group_eu_frankfurt',
    name: 'رابطة اتحاداوية الاتحاد الأوروبي',
    countryId: 'eu',
    countryName: 'الاتحاد الأوروبي',
    countryFlag: '🇪🇺',
    city: 'فرانكفورت / باريس',
    region: 'europe',
    description: 'رابطة مشجعي سيد البلد في الاتحاد الأوروبي، تجمعات لمشاهدة المباريات ومساعدة الجالية السكندرية في دول أوروبا.',
    coverImage: 'https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?q=80&w=1200&auto=format&fit=crop',
    logo: 'https://upload.wikimedia.org/wikipedia/ar/thumb/0/0e/Al_Ittihad_Alexandria_Club_Logo.svg/1024px-Al_Ittihad_Alexandria_Club_Logo.svg.png',
    status: 'approved',
    verified: true,
    featured: true,
    adminUid: 'admin_eu_1',
    adminName: 'م. يوسف الإسكندراني',
    adminEmail: 'eu@ittihad.club',
    adminPhone: '+491512345678',
    socialLinks: {
      whatsapp: 'https://chat.whatsapp.com/sample_eu'
    },
    memberCount: 480,
    eventsCount: 11,
    postsCount: 31,
    galleryCount: 40,
    foundedYear: '2020',
    meetingPlace: 'Alexandria Hub - Frankfurt / Paris',
    createdAt: '2023-04-10T12:00:00.000Z'
  },
  {
    id: 'group_east_asia_tokyo',
    name: 'رابطة اتحاداوية شرق آسيا',
    countryId: 'east_asia',
    countryName: 'شرق آسيا',
    countryFlag: '🌏',
    city: 'طوكيو / كوالالمبور',
    region: 'asia',
    description: 'ملتقى جماهير زعيم الثغر في دول وعواصم شرق وجنوب شرق آسيا، تنظيم تجمعات البث المباشر ولقاءات دورية.',
    coverImage: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?q=80&w=1200&auto=format&fit=crop',
    logo: 'https://upload.wikimedia.org/wikipedia/ar/thumb/0/0e/Al_Ittihad_Alexandria_Club_Logo.svg/1024px-Al_Ittihad_Alexandria_Club_Logo.svg.png',
    status: 'approved',
    verified: true,
    featured: true,
    adminUid: 'admin_ea_1',
    adminName: 'د. حازم السكندري',
    adminEmail: 'eastasia@ittihad.club',
    adminPhone: '+819012345678',
    socialLinks: {
      whatsapp: 'https://chat.whatsapp.com/sample_ea'
    },
    memberCount: 220,
    eventsCount: 6,
    postsCount: 19,
    galleryCount: 25,
    foundedYear: '2022',
    meetingPlace: 'Tokyo Sports Hall & KL Hub',
